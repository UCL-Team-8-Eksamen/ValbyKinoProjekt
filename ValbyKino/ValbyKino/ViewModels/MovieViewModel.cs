...
namespace ValbyKino.ViewModels
{
    public class MovieViewModel : ViewModelBase
    {
        ...
        //Forudsætningerne for at metoden fungerer er?
        //Movies er en gyldig samlingstype (f.eks. en liste: List<Movie>), og den er korrekt initialiseret et sted i min kode.
        //Klassen Movie er defineret, og dens konstruktør understøtter at modtage de angivne parametre, enten som en del af
        //konstruktøren eller som egenskaber, der kan initialiseres med objektinitialisering.
